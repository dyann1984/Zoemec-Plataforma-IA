...
export function ProjectHeader({ project, apus = [], budgets = [], surveys = [], onBackToProjects }) {
  const { t: tr } = useI18n();
  ...
  const lifecycleStage = deriveProjectLifecycleStage({ project, apus, budgets, surveys });
