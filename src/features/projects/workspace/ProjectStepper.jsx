      ...
      <div className="project-stepper-mobile" aria-label={tr('workspace.stepperMobileLabel')}>
          ...
          <div className="stepper-mobile-selector-wrap">
            ...
            >
              {WORKSPACE_STAGES.map((s, idx) => {
                const p = computeStageProgress(s.key, { project, apus, budgets, surveys });
                return (
        ...
        <div className="stepper-mobile-main-row">
          <div className="stepper-mobile-stage-info">
            ...
            <span className={`stepper-status-badge badge-status-${computeStageProgress(currentStageObj.key, { project, apus, budgets, surveys })}`}>
              {statusLabel(computeStageProgress(currentStageObj.key, { project, apus, budgets, surveys }))}
            </span>
          </div>
